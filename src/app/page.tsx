    ...
    <main className="mx-auto max-w-6xl min-h-[79vh]">
      <div className="flex justify-around mt-15">
        <div className=" top-20 left-10">
           <h1 className="text-xl font-medium text-[#1d3557]  dark:text-[#EAECEB] ">{name}</h1>
        ...
        <div className=" right-3 top-20">
          <Image className="" src="/mancoding2.png" alt="" width="400" height="0"></Image>
        </div>
      </div>
      <p className="text-xl font-medium px-12">Enjoy building and optimizing software applications,
         always on the lookout for new programming languages and techniques to learn,
              waiting for the great opportunity from you.</p>
      <div className="flex">
        <button className="after:bg-black btn btn-border-reveal w-auto px-10 ml-12 py-2 
